...
public class Problems5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        problems[0] = new Problem1_5_1();
        problems[1] = new Problem1_5_2();
        problems[2] = new Problem1_5_3();
        problems[3] = new Problem1_5_4();
        problems[4] = new Problem1_5_5();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.about:
                Intent intent = new Intent(Problems5Activity.this, InfoActivity.class);
                startActivity(intent);
                return true;
            case R.id.tasks:
                intent = new Intent(Problems5Activity.this, MainActivity.class);
                startActivity(intent);
                return true;
            default:
    ...
    public void test(View view) {
            ...
            if (problems[count].getVerdict()) {
                ...
                if (count < nProblems) {
                    ...
                    Intent intent = new Intent(Problems5Activity.this, EndScreenActivity.class);
                    startActivity(intent);
                }
            } else {
                mEditTextAnswer.setText("");
